...
export const metadata: Metadata = {
  title: 'Cancellation & Refund Policy | SmoothCoders',
  description: 'Cancellation and Refund Policy for SmoothCoders services. Learn about our return, refund, and cancellation policies.',
};

export default function CancellationRefund() {
  return (
    <main className="min-h-screen pt-24 pb-16 bg-gradient-to-br from-gray-50 via-white to-blue-50">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <p className="text-sm text-gray-500 mb-8">
              Last updated on 27-09-2024 23:39:33
            </p>

            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-6">
                These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between SMOOTH CODERS, Owned By Pradip Namdeo Vhasale ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").
              </p>
              ...
              <ol className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <li>
                  Your use of our Services and the websites solely at your own risk and discretion. You are required to independently assess and ensure that the Services meet your requirements.
                </li>
                <li>
                ...
                <li>
                  All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Vaijapur, Maharashtra.
                </li>
                <li>
