...
export const metadata: Metadata = {
  title: 'Privacy Policy | SmoothCoders',
  description: 'Privacy Policy for SmoothCoders. Learn how we collect, use, and protect your personal information.',
};
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <a href="https://smoothcoders.com" className="text-blue-600 hover:underline">
                    https://smoothcoders.com
                  </a>
                  .
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <a href="https://automattic.com/privacy/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
