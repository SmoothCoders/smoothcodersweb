...
export const metadata: Metadata = {
  title: 'Terms & Conditions | SmoothCoders',
  description: 'Terms and Conditions for using SmoothCoders services. Read our terms of service, user agreements, and legal policies.',
};
